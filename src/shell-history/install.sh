...
# TODO - explore ash history
# # Set HISTFILE for ash
# echo "******************************************************************************"
# echo "* Installing ash history"
# echo "******************************************************************************"
# cat << EOF >> "$_REMOTE_USER_HOME/.ashrc"
# export HISTFILE=/dc/shellhistory/.ash_history
# export PROMPT_COMMAND='history -a'
# EOF
# sudo chown -R $_REMOTE_USER $_REMOTE_USER_HOME/.ashrc
